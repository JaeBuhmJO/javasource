...
<form action="insertPro.jsp" method="post">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="birthYear" name = "birthYear" placeholder="태어난해 입력">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="mobile" name = "mobile" placeholder="전화번호 ex)010-1234-5678 형태로 입력">
  </div>
