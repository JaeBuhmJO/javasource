...
<main>
	...
	<form action='<c:url value="/update.do"/>' method="post" enctype="multipart/form-data">
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="inputName" name="name" value="${dto.name }">
			</div>
		</div>
		<div class="row mb-3">
		...
		<div class="row mb-3">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="inputContent" rows="10" name="content">${dto.content}</textarea>
			</div>
		</div>
		<div class="row mb-3">
...
<form action="" id="modifyForm">
	<input type="hidden" name="bno" value='${dto.bno }' />
	<input type="hidden" name="passwordTodelete" value='' />
	<input type="hidden" name="criteria" value="${pageDTO.criteria }"/>
	<input type="hidden" name="keyword" value="${pageDTO.keyword }"/>
	<input type="hidden" name="page" value="${pageDTO.page }"/>
	<input type="hidden" name="amount" value="${pageDTO.amount }"/>
